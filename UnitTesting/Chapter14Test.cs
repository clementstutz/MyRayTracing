...
namespace RT.UnitTesting
{
    ...
    class Chapter14Test
    {
        ...
        {
            Group g1 = new Group();
            g1.SetMatrix(Mat4.RotateYMatrix(Math.PI / 2.0));
            Group g2 = new Group();
        ...
        {
            Group g1 = new Group();
            g1.SetMatrix(Mat4.RotateYMatrix(Math.PI / 2));
            Group g2 = new Group();
        ...
        public void T12_RenderingLotsOfObjects()
        {
            ...
            camera.ViewTransform(new Point(25, 20, -30),
                                 new Point(25, 20, 40),
                                 new Vector(0, 1, 0));

            Canvas canvas = Scene.current.Render(camera);
            Save.SaveCanvas(canvas, "Chapter_14_FieldOfSpheres");
            Scene.current.Clear();
        ...
        public RayObject HexagonCorner()
        {
            ...
            corner.SetMatrix(Mat4.TranslateMatrix(0, 0, -1) *
        ...
        public RayObject HexagonEdge()
        {
            ...
            edge.SetMatrix(Mat4.TranslateMatrix(0, 0, -1) *
                           Mat4.RotateYMatrix(Math.PI / -6) *
                           Mat4.RotateZMatrix(Math.PI / -2) *
        ...
        public RayObject Hexagon()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                side.SetMatrix(Mat4.RotateYMatrix(i * Math.PI / 3));
        ...
        public void T13_PuttingItAllTogether()
        {
            ...
            Camera camera = new Camera(100, 80, Math.PI / 3.0);
            camera.ViewTransform(new Point(0, 2, -2),
                                 new Point(0, 0, 0),
                                 new Vector(0, 1, 0));

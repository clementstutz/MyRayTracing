        ...
        public void Load(string filename)
        {
            ...
            if (System.IO.File.Exists(filename))
            {
                ...
                while ((line = file.ReadLine()) != null)
                {
                    ...
                    {
                        if (parameters.Length == 4 || parameters.Length == 5) // v : List of geometric vertices, with (x, y, z, [w]) coordinates, w is optional and defaults to 1.0.
                        {
                            try
                            {
                            ...
                            {
                                Console.WriteLine("ligne = " + lineNumber + "parameters[1:3] = " + parameters[1] + parameters[2] + parameters[3]);
                                break;
                            }
                        }
                    ...
                    else if (parameters[0] == "vn") // vn : List of vertex normals in (x,y,z) form; normals might not be unit vectors.
                    {
                    ...
                    else if (parameters[0] == "f")  // f : Polygonal face element
                    {
                        if (parameters.Length >= 4)
                        {
                    ...
                    if (lineNumber % 1 == 0)
                        //Console.WriteLine("progression lecture = " + lineNumber);
                    lineNumber++;
                }
                Console.WriteLine("Nb de triangles = " + t.Count);
                file.Close();
            }
        }
